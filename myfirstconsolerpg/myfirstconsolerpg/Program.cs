...
namespace myfirstconsolerpg
{
    class Program
    {
        public static Player player = new Player("Hero", 25, 5);
        public static Monster monster = new Monster("Monster", 15, 1);
        public static Monster monster1 = new Monster("Evil Voice", 30, 1);
